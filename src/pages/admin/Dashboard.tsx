                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center justify-between">
                      <div className="min-w-0 flex-1">
                        ...
                        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mt-1">
                          {marketplaces.length}
                        </h3>
                      </div>
                      ...
                      <table className="w-full min-w-[600px]">
                        <thead>
                          <tr className="border-b">
                            <th className="text-left py-3 px-3 sm:px-4 text-xs sm:text-sm font-medium text-gray-500">
                              Marketplace
                            </th>
                            <th className="text-left py-3 px-3 sm:px-4 text-xs sm:text-sm font-medium text-gray-500">
                              Vendedores
